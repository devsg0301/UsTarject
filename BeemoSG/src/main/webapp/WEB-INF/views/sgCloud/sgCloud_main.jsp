		            		...
		            		<ul class="nav navbar-nav">
					            ...
					            <li class="panel panel-default" id="dropdown">
					                ...
					                <div id="dropdown-utility1" class="panel-collapse collapse <c:if test="${category == 'UTILITY'}">in</c:if>" <c:if test="${category == 'UTILITY'}">aria-expanded="true"</c:if>>
					                    <div class="panel-body">
					                        <ul class="nav navbar-nav">
	                                            <li style="padding-left:30px;"><a style="<c:if test="${category == 'UTILITY' && genre == ''}">font-weight: 600; color: #333;</c:if>" href="/sgCloud/sgCloud_main.do?category=UTILITY"><i class="fa fa-caret-right"></i>전체</a></li>
	                                            <li style="padding-left:30px;"><a style="<c:if test="${genre == '소프트웨어'}">font-weight: 600; color: #333;</c:if>" href="/sgCloud/sgCloud_main.do?category=UTILITY&genre=소프트웨어"><i class="fa fa-caret-right"></i>소프트웨어</a></li>
	                                            <li style="padding-left:30px;"><a style="<c:if test="${genre == '보안ㆍ백신'}">font-weight: 600; color: #333;</c:if>" href="/sgCloud/sgCloud_main.do?category=UTILITY&genre=보안ㆍ백신"><i class="fa fa-caret-right"></i>보안ㆍ백신</a></li>
	                                            <li style="padding-left:30px;"><a style="<c:if test="${genre == '기타설치'}">font-weight: 600; color: #333;</c:if>" href="/sgCloud/sgCloud_main.do?category=UTILITY&genre=기타설치"><i class="fa fa-caret-right"></i>기타설치</a></li>
					                        </ul>
					                    </div>
					                </div>
					            </li>
