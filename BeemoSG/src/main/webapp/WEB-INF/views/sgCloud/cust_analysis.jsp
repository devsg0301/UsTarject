...
<script type="text/javascript">
	...
	function paging(rnum){
		if (!(tmpUser.indexOf("iPhone") > 0 || tmpUser.indexOf("iPod") > 0 || tmpUser.indexOf("Android ") > 0 )){		
			location.href = "/sgCloud/cust_analysis.do?rnum=" + rnum;
		}else{
			location.href = "/sgCloud/cust_analysis.do?rnum=" + rnum + "#view_position";
		}
	}
					...
					<nav class="navbar navbar-default" role="navigation">
		            	<div class="side-menu-container">
		            		<ul class="nav navbar-nav">
					            ...
					            <!-- Dropdown-->
					            <li class=""><a href="/sgCloud/cust_analysis.do" style="font-weight: 600; color: #333;"><i class="fas fa-chart-line fa-fw"></i> 사용자분석</a></li>
