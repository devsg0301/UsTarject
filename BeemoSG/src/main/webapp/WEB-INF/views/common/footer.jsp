				...
				<form class="form-signin" name="loginForm" id="loginForm" method="post" action="/defaults/loginProcess.do">
					<div class="form-group">
						<div class="input-group">
							...
							<label for="cust_id" class="input-group-addon"><i class="fa fa-user" aria-hidden="true"></i></label>
						</div>
					</div> <!-- /.form-group -->
					...
					<div class="form-group">
						<div class="input-group">
							...
							<label for="password" class="input-group-addon"><i class="fa fa-lock" aria-hidden="true"></i></label>
						</div> <!-- /.input-group -->
					</div> <!-- /.form-group -->
